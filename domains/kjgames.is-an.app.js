...
addSubDomain({
  description: 'JioGames by Kavyansh!', // describe your project in this field
  domain: 'is-an.app', // aka "root-domain". select between '1bt.uk' and 'is-an.app'
  subdomain: 'kjgames', // desired subdomain name
  owner: {
    repo: '<https://URL/to/the/repository/with/your/project/sources/if/it/is/public>',
    email: '<your-public@email.address>',
  },
  record: {
    CNAME: 'https://kavyanshkhaitan2.github.io/jiogames/', // e.g.: <your-github-account>.github.io
